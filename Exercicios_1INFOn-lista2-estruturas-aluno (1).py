...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    novo preço"""
    novopreco = preco_original-(preco_original/100*percentual_desconto)
...
def dias_para_segundos(dias, horas, minutos, segundos):
    ...
    a data em segundos"""
    dias_para_segundos = (dias*86400)+(horas*3600)+(minutos*60)+(segundos*1)
    return round(dias_para_segundos, 2)
